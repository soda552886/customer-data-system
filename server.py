...
def api_export_sales_csv():
    ...
    total_fields = [
        ...
        'surcharge', 'applianceGift', 'pickupVoucher', 'decoration', 'companyLoanInterest',
        'houseBasePrice', 'parkingBasePrice', 'baseTotal', 'excessPrice', 'commissionSalesAmount',
    ...
    writer.writerow([
        ...
        round(totals['houseBasePrice'], 4), round(totals['parkingBasePrice'], 4),
